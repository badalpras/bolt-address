...
const MapControls = ({
  ...
  return (
    <div className="p-4 bg-white border-b border-gray-200">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              disabled={!startingAddress || isGeocodingStart}
              className="inline-flex items-center justify-center w-10 h-10 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
            ...
            <button
              ...
              className="inline-flex items-center justify-center w-10 h-10 bg-gray-600 text-white rounded-lg hover:bg-gray-700"
      ...
      {!isStartingPointValid && startingAddress && (
